	...
	<div class="bg-dark" id="sidebar-wrapper">
		<div class="sidebar-heading py-4 text-light  border-bottom">
			<span class="fs-5 mb-5 text-uppercase"
				style="letter-spacing: 1px; font-weight: normal;">ADMIN Role</span>
		...
		<div class="list-group list-group-flush my-3">
			<a href="Dashboard.jsp"
				...
				href="categories.jsp" role="button" aria-expanded="false"><i
				class="fas fa-file me-2"></i> Categories </a> <a
				class="nav-link  list-group-item list-group-item-action bg-transparent second-text fw-bold"
				href="bookauthor.jsp" role="button" aria-expanded="false"><i
				class="fas fa-users me-2"></i> Authors </a> <a
				class="nav-link  list-group-item list-group-item-action bg-transparent second-text fw-bold"
				href="book.jsp" role="button" aria-expanded="false"><i
				class="fas fa-book-open me-2"></i>Book </a> <a
				class="nav-link  list-group-item list-group-item-action bg-transparent second-text fw-bold"
				href="bookissue.jsp" role="button" aria-expanded="false"><i
				class="fas fa-book-open"></i> Issued Book </a> <a
				class="nav-link  list-group-item list-group-item-action bg-transparent second-text fw-bold"
				href="registerstd.jsp" role="button" aria-expanded="false"><i
				class="fas fa-user me-2"></i> Register Student </a><a
				href="changePassword.jsp"
				class="list-group-item list-group-item-action bg-transparent second-text fw-bold"
				data-bs-toggle="modal" data-bs-target="#pwd"><i
				class="fas fa-key me-2"></i>Change Password</a> <a href="../index.jsp"
