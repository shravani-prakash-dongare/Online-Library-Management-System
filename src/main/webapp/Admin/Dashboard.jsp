						...
						<div class="row g-3 my-2 align-items-center">
							...
							<ul class="box-info">
								...
								<li><i class='fas fa-book-open i1'></i> <span class="text">
										<a href="book.jsp" style="text-decoration: none;"><p>Book
												Listed</p>
											<p>
												<%
												try {
								...
								<li><i class='fas fa-users i2 '></i> <a
									href="registerstd.jsp" style="text-decoration: none;"><span
										class="text">
								...
								<li><i class='fas fa-users i2 bg-success'></i> <a
									href="bookauthor.jsp" style="text-decoration: none;"><span
										class="text">
											<p>Authors Listed</p>
											<p>
												<%
												try {
													...
													Connection con = ConnectionProviders.getCon();
													Statement st = con.createStatement();
													ResultSet rs = st.executeQuery("SELECT COUNT(id) FROM authors");
													while (rs.next()) {
												%>
												<b><%=rs.getString(1)%></b>
												<%
								...
								<li><i class='fas fa-users i1'></i> <a
									href="categories.jsp" style="text-decoration: none;"><span
										class="text">
