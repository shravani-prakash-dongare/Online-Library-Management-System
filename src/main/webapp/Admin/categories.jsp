				...
				<div class="card-body">
					<div style="justify-content: space-between;" class="d-flex">
						...
						<button class="btn btn-success" type="button"
							...
							class="btn btn-info">Add New Category</button>
					</div>
						...
						<div class="modal-dialog text-dark">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form class="container" action="categoryAction.jsp"
										method="post">
									...
									<tbody>
										...
										<tr>
											...
											<td><a class="btn btn-primary btn-sm"
												...
												href="delete1.jsp?id=<%=rs.getInt("id")%>"
	...
	<div class="modal" id="demoedit">
		<div class="modal-dialog text-dark">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="container" action="categoryEdit.jsp" method="post">
						<div class="form-group">
							<label for="exampleInputEmail1">Category name</label> <input
								type="text" class="form-control"
								placeholder="shraudongare@gmail.com" name="category">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Status</label> <select
								class="form-control" name="status">
