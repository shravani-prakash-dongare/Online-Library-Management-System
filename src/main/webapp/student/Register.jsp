...
<body>
	<div class="container">
		...
		%>
		<div class="text-center alert text-danger">Something Went Wrong
			on Server.! Try Again</div>
		<%
		}
		%>
		<%
		if ("wrongpwd".equals(msg)) {
		%>

		<div class="text-center alert text-danger">Password & Confirm
		...
		<div class="text-center alert text-success">
			Registred Successfully....!<a href="login.jsp"
				style="text-align: center;"> Click here to login</a>
		</div>
		<%
		}
		%>
		...
		<div class="content">
				...
				<div class="user-details">
					...
					<div class="input-box">
						<span class="details">Phone Number</span> <input type="number"
							placeholder="Enter your number" required name="mobileno">
					</div>
					<div class="input-box">
					...
					<div class="input-box">
						<span class="details">Password</span> <input type="password"
							placeholder="Enter your password" required name="pwd">
					</div>
					<div class="input-box">
			...
			<a href="../index.jsp" style="text-align: center;"> Go Back to Home</a>
		</div>
	</div>
